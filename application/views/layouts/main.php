        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">Gudang</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">Gudang</span>
                </a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li>
                                    <a href="<?php echo site_url('reseller/index');?>">
                                        <i class="fa fa-address-book-o"></i> <span>Reseller</span>
                                    </a>
                                </li>
                                <li>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-balance-scale"></i> <span>Transaction</span>
                            </a>
                            <ul class="treeview-menu">
                                <li>
            ...
            <footer class="main-footer">
                <strong>Develop By <a href="https://bukaide.com">bukaide</a></strong>
            </footer>
