    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Barang Retur Edit</h3>
            </div>
			<?php echo form_open('barang_retur/edit/'.$barang_retur['rtr_id']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="brg_id" class="form-control">
								...
								{
									$selected = ($barang['brg_id'] == $barang_retur['brg_id']) ? ' selected="selected"' : "";
