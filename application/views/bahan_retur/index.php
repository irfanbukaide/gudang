    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Bahan Retur Listing</h3>
            	<div class="box-tools">
                    <a href="<?php echo site_url('bahan_retur/add'); ?>" class="btn btn-success btn-sm">Add</a>
                </div>
            </div>
            <div class="box-body">
                <table class="table table-striped">
                    ...
                    <tr>
						...
						<td>
                            <a href="<?php echo site_url('bahan_retur/edit/' . $b['rtr_id']); ?>"
                               class="btn btn-info btn-xs"><span class="fa fa-pencil"></span> Edit</a>
                            <a href="<?php echo site_url('bahan_retur/remove/' . $b['rtr_id']); ?>"
